...
#define SOCKET_ADDRESS INADDR_ANY
#define SOCKET_PORT 62390U
...
#define REMOTE_ADDRESS_STRING_MAX_SIZE (REMOTE_IP_STRING_MAX_SIZE + 1 + REMOTE_PORT_STRING_MAX_SIZE)
